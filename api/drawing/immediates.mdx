---
title: "LWXGL Immediate-Mode Drawing: Text, Shapes, and Lines"
sidebarTitle: "Immediates"
description: "Draw text, rectangles, ellipses, and lines directly to the LWXGL back-buffer each frame — cleared automatically before the next frame."
---
