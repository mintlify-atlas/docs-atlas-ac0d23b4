...
sidebarTitle: "OpenGL"
description: "Create a GLX-backed OpenGL surface element inside an LWXGL window, make it the active context, render with standard OpenGL calls, and synchronize before compositing."
---
