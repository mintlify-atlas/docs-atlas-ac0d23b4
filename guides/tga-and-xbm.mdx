...
description: "Load 8-bit indexed TGA files and monochrome XBM bitmaps, render them into image elements, optionally remap the palette, and capture screen regions as TGA buffers."
---
